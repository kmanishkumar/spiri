...
import 'otprepo/otpRepo.dart';

class Otp extends StatefulWidget {
  final String mobileNuber;

  const Otp({Key key, this.mobileNuber}) : super(key: key);
...
////        await ForgotPasswordRepo.resetPasswordAgain(context,email);
////      },
//    );
//  }
...
//            color: Colors.grey.withOpacity(0.4),
  ...
  // AppNavigator.pp(SighupP)

//        OtpRepo.otpVerification(context,otp);
